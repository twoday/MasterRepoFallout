	...
	<html>
		...
		<body>
			...
			<div id="skillcontainer">
							...
							<td>
								<div class="skillcen">
									...
									<table class="insk">
                                        ...
                                        $select_item_info = mysqli_query($link, "SELECT `Towns`, `Resources`, `Levels`, `Item_Drop(s)` FROM `items` WHERE `Skills` = \"Speed\" AND `Item_use` != \"Mount\"");
				...
				>
				<a href="speed.php" class="manlinks">Speed</a>
			</div>
			<footer>
				<br>
				<center>

...
$select_actions = mysqli_query($link,
	"SELECT * FROM `actions` WHERE `name` LIKE 'Crush %' AND `skill_id` = \"1\" ORDER BY `level` ASC");
...
$select_actions = mysqli_query($link,
	"SELECT * FROM `actions` WHERE `name` LIKE '% Potion' AND `skill_id` = \"1\" ORDER BY `level` ASC");
while ($actions = mysqli_fetch_assoc($select_actions)) {
	$select_drops = mysqli_query($link,
		"SELECT * FROM `action_drops` WHERE `action_id` = " . $actions['id']);
	echo "<tr>";
...
$select_actions = mysqli_query($link,
	"SELECT * FROM `actions` WHERE `name` LIKE '% Dye' AND `skill_id` = \"1\" ORDER BY `level` ASC");
while ($actions = mysqli_fetch_assoc($select_actions)) {
	$select_drops = mysqli_query($link,
		"SELECT * FROM `action_drops` WHERE `action_id` = " . $actions['id']);
	echo "<tr>";
...
$select_actions = mysqli_query($link,
	"SELECT * FROM `actions` WHERE `name` LIKE 'Prepare %' AND `name` NOT LIKE '% Potion' AND `name` NOT LIKE '% Dye' AND `skill_id` = \"1\" ORDER BY `level` ASC");
while ($actions = mysqli_fetch_assoc($select_actions)) {
	$select_drops = mysqli_query($link,
		"SELECT * FROM `action_drops` WHERE `action_id` = " . $actions['id']);
	echo "<tr>";
...
$select_equipment = mysqli_query($link,
	"SELECT * FROM `equipment` WHERE `required_skill` = \"1\" ORDER BY `skill_level` ASC");
...
?>
				...
				>
				<a href="alchemy.php" class="manlinks">Alchemy</a>
			</div>
			<footer>
				<br>
				<center>

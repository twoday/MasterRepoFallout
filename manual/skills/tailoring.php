...
$select_actions = mysqli_query($link,
	"SELECT * FROM `actions` WHERE `name` LIKE 'Tan %' AND `skill_id` = \"11\" ORDER BY `level` ASC");
...
$select_actions = mysqli_query($link,
	"SELECT * FROM `actions` WHERE `name` LIKE '% Leather %' AND `skill_id` = \"11\" ORDER BY `level` ASC");
while ($actions = mysqli_fetch_assoc($select_actions)) {
	$select_drops = mysqli_query($link,
		"SELECT * FROM `action_drops` WHERE `action_id` = " . $actions['id']);
	echo "<tr>";
	...
	$tool = "";
	while ($tool_info = mysqli_fetch_assoc($select_tool_info)) {
		...
		$select_tools = mysqli_query($link, "SELECT `name` FROM `items` WHERE `id`=" . $tool_id['item_id']);
		$tools = mysqli_fetch_assoc($select_tools);
		$tool .= $tools['name'] . " <br />";
	}
...
$select_actions = mysqli_query($link,
	"SELECT * FROM `actions` WHERE `name` LIKE '% Bear %' AND `skill_id` = \"11\" ORDER BY `level` ASC");
while ($actions = mysqli_fetch_assoc($select_actions)) {
	$select_drops = mysqli_query($link,
		"SELECT * FROM `action_drops` WHERE `action_id` = " . $actions['id']);
	echo "<tr>";
...
$select_actions = mysqli_query($link,
	"SELECT * FROM `actions` WHERE `name` LIKE 'Dye %' AND `skill_id` = \"11\" ORDER BY `level` ASC");
while ($actions = mysqli_fetch_assoc($select_actions)) {
	$select_drops = mysqli_query($link,
		"SELECT * FROM `action_drops` WHERE `action_id` = " . $actions['id']);
	echo "<tr>";
...
$select_actions = mysqli_query($link,
	"SELECT * FROM `actions` WHERE `name` LIKE '% Snake Hide %' AND `skill_id` = \"11\" ORDER BY `level` ASC");
while ($actions = mysqli_fetch_assoc($select_actions)) {
	$select_drops = mysqli_query($link,
		"SELECT * FROM `action_drops` WHERE `action_id` = " . $actions['id']);
	echo "<tr>";
...
$select_equipment = mysqli_query($link,
	"SELECT * FROM `equipment` WHERE `required_skill` = \"11\" ORDER BY `skill_level` ASC");
...
?>
				...
				>
				<a href="tailoring.php" class="manlinks">Tailoring</a>
			</div>
			<footer>
				<br>
				<center>

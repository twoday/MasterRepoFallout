...
<?php
$get_player_info = mysqli_query($link, "SELECT `player_id`, `level`, `exp` FROM `player_skill` WHERE `skill_name` = \"Gathering\" ORDER BY `exp` DESC LIMIT 0, 100");
$rank = 1;

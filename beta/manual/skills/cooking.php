...
$select_actions = mysqli_query($link,
	"SELECT * FROM `actions` WHERE `skill_id` = \"5\" ORDER BY `level` ASC");
...
$select_equipment = mysqli_query($link,
	"SELECT * FROM `equipment` WHERE `required_skill` = \"5\" ORDER BY `skill_level` ASC");
...
?>
				...
				>
				<a href="cooking.php" class="manlinks">Cooking</a>
			</div>
			<footer>
				<br>
				<center>

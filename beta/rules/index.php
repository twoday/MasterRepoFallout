...
You cannot have multiple accounts. You are only allowed one account per IP unless you have other members of the household playing. Please inform the administrators and other staff of the other accounts on the same IP. Having multiple accounts will result in all "multiple" accounts being banned.<br>
         ...
         <br>
             I. Character Names must be appropriate, if they are deemed offensive the player will be asked once to change their name. If the player does not fulfill the request, their name will be chosen by the administration. <br>
             The chosen name will stay for a full 7 days before given the player a chance to comply for a name change. If the player chooses not to change their name they will be banned. <br>
             <br>

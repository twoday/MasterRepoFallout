...
function paperdoll() {
	$('#inventory_popup').load("game_includes/doll.php");
}
...
function guild(id) {
	$('#inventory_popup').load("game_includes/guild.php", {
		id: id
	});
...
function map() {
	$('#inventory_popup').load("game_includes/map.php");
        document.getElementById("inventory_popup").style.display = "block";
}
...
function messages(id) {
	$('#inventory_popup').load("messages.php", {
		id: id
	});
}
...
function admin_panel(id) {
	$('#inventory_popup').load("game_includes/admin_panel.php", {
		id: id
	});
}
...
function mod_panel(id) {
	$('#inventory_popup').load("game_includes/mod_panel.php", {
		id: id
	});
}
...
function settings() {
	$('#inventory_popup').load("game_includes/change_theme.php");
    document.getElementById("inventory_popup").style.display = "block";
}
